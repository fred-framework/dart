create_ip -vlnv xilinx.com:ip:xfft -module_name fft_config1_1_core
set_property -dict [list \
    ...
    CONFIG.xk_index {0} \
] -objects [get_ips fft_config1_1_core]
set_property generate_synth_checkpoint false [get_files fft_config1_1_core.xci]
generate_target {synthesis simulation} [get_files fft_config1_1_core.xci]
