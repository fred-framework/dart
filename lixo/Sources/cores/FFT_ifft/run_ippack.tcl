...
start_for_dummy_proc_middle_U0
start_for_dummy_proc_be_U0
start_for_fft_config1_1_U0
...
set Interfaces {
    s_axi_ctrl_bus {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 direction W 0x0 "Data signal of direction" {{0 1 direction W 0 "Bit 0 to 0 Data signal of direction"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x18 in_M_real_V W 0x0 "Data signal of in_M_real_V" {{0 32 in_M_real_V W 0 "Bit 31 to 0 Data signal of in_M_real_V"}}} {0x20 in_M_imag_V W 0x0 "Data signal of in_M_imag_V" {{0 32 in_M_imag_V W 0 "Bit 31 to 0 Data signal of in_M_imag_V"}}} {0x28 out_M_real_V W 0x0 "Data signal of out_M_real_V" {{0 32 out_M_real_V W 0 "Bit 31 to 0 Data signal of out_M_real_V"}}} {0x30 out_M_imag_V W 0x0 "Data signal of out_M_imag_V" {{0 32 out_M_imag_V W 0 "Bit 31 to 0 Data signal of out_M_imag_V"}}} {0x38 ovflo R 0x0 "Data signal of ovflo" {{0 1 ovflo R 0 "Bit 0 to 0 Data signal of ovflo"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x3c ovflo_ctrl R 0x0 "Control signal of ovflo" {{0 1 ovflo_ap_vld R 0 "Control signal ovflo_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_ctrl_bus m_axi_mem_bus"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_mem_bus {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_mem_bus"
        data_width "32"
        param_prefix "C_M_AXI_MEM_BUS"
...
## System Info
set user_parameters_list {clk_period 3.3 machine 64 combinational 0 latency 11265 II x}
