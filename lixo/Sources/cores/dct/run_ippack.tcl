...
set Interfaces {
    s_axi_ctrl_bus {
        ...
        registers {{0x10 in_block W 0x0 "Data signal of in_block" {{0 32 in_block W 0 "Bit 31 to 0 Data signal of in_block"}}} {0x18 out_block W 0x0 "Data signal of out_block" {{0 32 out_block W 0 "Bit 31 to 0 Data signal of out_block"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
