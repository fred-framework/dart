...
set sdx_kernel_name "acc"
set sdx_kernel_type ""
set sdx_kernel_files {}
set enable_xo_gen 0
set sdaccel_dir [file join [pwd] .. kernel]
set solution_dir "/usr/local/src/xilinx/xilinx_18/AMPERE_DART/dart_bbox_ips/acc_bbox/solution1"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {acc_mul_64s_64s_6bkb
acc_mod_mat_a_0_V
acc_mod_mat_p_V
fifo_w32_d2_A
fifo_w32_d2_A
...
set Interfaces {
    s_axi_ctrl_bus {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 id R 0x0 "Data signal of id" {{0 32 id R 0 "Bit 31 to 0 Data signal of id"}}} {0x14 id_ctrl R 0x0 "Control signal of id" {{0 1 id_ap_vld R 0 "Control signal id_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x40 mem_in_V W 0x0 "Data signal of mem_in_V" {{0 32 mem_in_V W 0 "Bit 31 to 0 Data signal of mem_in_V"}}} {0x48 mem_out_V W 0x0 "Data signal of mem_out_V" {{0 32 mem_out_V W 0 "Bit 31 to 0 Data signal of mem_out_V"}}}}
        memories "args {base_address 32 range 32}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
